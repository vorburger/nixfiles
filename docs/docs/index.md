...
<!-- TODO Dynamically insert bullet points tree generated from nav in mkdocs.yaml here,
       by writing a Java utility in Enola, and have ExecMD able to run it in-process, with a generic tool:nav sort of syntax... -->

<!-- PS: This documentation, with its tutorial/ vs reference/ distinction, is based on the https://diataxis.fr framework. -->
