...
Alternatively, you can also install `nix` from https://nixos.org/download. (Not recommended on Fedora Linux [due to SELinux bug](https://github.com/NixOS/nix/issues/2374).)
